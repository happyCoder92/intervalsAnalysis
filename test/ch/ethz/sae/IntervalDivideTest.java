...
public class IntervalDivideTest extends IntervalBinaryOperationTest {
	...
	public static Collection<Interval[]> intervals() {
		return Arrays.asList(new Interval[][] {
				...
				// FIXME
				{ i(0, 10), i(1, 20), i(0, 10) }, // range range
				{ i(5, 10), i(2, 20), i(0, 5) }, // .
				{ i(0, 10), i(-20, -1), i(-10, 0) }, // .
				{ i(5, 10), i(-20, -2), i(-5, 0) }, // .
				{ i(-10, 0), i(1, 20), i(-10, 0) }, // .
				{ i(-10, -5), i(2, 20), i(-5, 0) }, // .
				{ i(-10, 0), i(-20, -1), i(0, 10) }, // .
				{ i(-10, -5), i(-20, -2), i(0, 5) }, // .
				{ i(-10, 12), i(1, 20), i(-10, 12) }, // .
				{ i(-10, 12), i(2, 20), i(-5, 6) }, // .
				{ i(-10, 12), i(-20, -1), i(-12, 10) }, // .
				{ i(-10, 12), i(-20, -2), i(-6, 5) }, // .
				{ i(-10, 10), i(-10, 10), i(mi, ma) }, // . division by zero should go to top
				{ i(0, ma), i(1, 20), i(0, ma) }, // . boundaries
				{ i(0, ma), i(2, 20), i(0, ma/2) }, // . .
				{ i(0, ma), i(-20, -1), i(-ma, 0) }, // . .
				{ i(0, ma), i(-20, -2), i(ma/(-2), 0) }, // . .
				{ i(mi, 0), i(1, 20), i(mi, 0) }, // . .
				{ i(mi, 0), i(2, 20), i(mi/2, 0) }, // . .
				{ i(mi, 0), i(-20, -1), i(mi, ma) }, // . . overflow
				{ i(mi, 0), i(-20, -2), i(0, mi/(-2)) }, // . .
				{ i(mi, ma), i(1, 20), i(mi, ma) }, // . .
				{ i(mi, ma), i(2, 20), i(mi/2, ma/2) }, // . .
				{ i(mi, ma), i(-20, -1), i(mi, ma) }, // . . overflow
				{ i(mi, ma), i(-20, -2), i(ma/(-2), mi/(-2)) }, // . .
				});
	}
